...
import net.mcreator.moreoresandarmour.item.ShadowShovelItem;
...
public class ShadowPickaxeBlockDestroyedWithToolProcedure extends MoreOresAndArmourModElements.ModElement {
	public ShadowPickaxeBlockDestroyedWithToolProcedure(MoreOresAndArmourModElements instance) {
		super(instance, 512);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure ShadowPickaxeBlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure ShadowPickaxeBlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure ShadowPickaxeBlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure ShadowPickaxeBlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure ShadowPickaxeBlockDestroyedWithTool!");
			return;
		}
		...
		if (((new ItemStack(ShadowShovelItem.block, (int) (1)).getItem()
