...
import net.mcreator.moreoresandarmour.procedures.TurquoiseAppleFoodEatenProcedure;
...
public class TurquoiseAppleItem extends MoreOresAndArmourModElements.ModElement {
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("turquoise_apple");
		}
		...
		public ItemStack onItemUseFinish(ItemStack itemStack, World world, LivingEntity entity) {
			...
			double z = entity.getPosZ();
			{
				...
				TurquoiseAppleFoodEatenProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
