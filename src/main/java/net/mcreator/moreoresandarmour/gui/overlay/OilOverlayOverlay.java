...
import net.mcreator.moreoresandarmour.procedures.OilOverlayDisplayOverlayIngameProcedure;
...
public class OilOverlayOverlay extends MoreOresAndArmourModElements.ModElement {
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (OilOverlayDisplayOverlayIngameProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world))) {
