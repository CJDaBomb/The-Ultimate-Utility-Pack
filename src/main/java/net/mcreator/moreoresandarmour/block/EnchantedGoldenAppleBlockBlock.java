...
public class EnchantedGoldenAppleBlockBlock extends MoreOresAndArmourModElements.ModElement {
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry()
				.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("enchanted_golden_apple_block"));
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("enchanted_golden_apple_block");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Enchanted Golden Apple Block");
		}
