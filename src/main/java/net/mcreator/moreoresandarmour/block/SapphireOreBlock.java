...
import net.mcreator.moreoresandarmour.procedures.SapphireOreBlockDestroyedByPlayerProcedure;
import net.mcreator.moreoresandarmour.procedures.SapphireOreBlockDestroyedByExplosionProcedure;
...
public class SapphireOreBlock extends MoreOresAndArmourModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5f, 10f).lightValue(0).harvestLevel(4)
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				SapphireOreBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onExplosionDestroy(World world, BlockPos pos, Explosion e) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				SapphireOreBlockDestroyedByExplosionProcedure.executeProcedure($_dependencies);
			}
		}
	}
	@Override
