...
public class ShadowRockBrickBlock extends MoreOresAndArmourModElements.ModElement {
	@ObjectHolder("more_ores_and_armour:shadow_rock_brick")
	public static final Block block = null;
	public ShadowRockBrickBlock(MoreOresAndArmourModElements instance) {
		super(instance, 215);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("shadow_rock_brick");
		}
