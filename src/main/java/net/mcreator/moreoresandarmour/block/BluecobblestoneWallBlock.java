...
public class BluecobblestoneWallBlock extends MoreOresAndArmourModElements.ModElement {
	@ObjectHolder("more_ores_and_armour:bluecobblestone_wall")
	public static final Block block = null;
	public BluecobblestoneWallBlock(MoreOresAndArmourModElements instance) {
		super(instance, 247);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("bluecobblestone_wall");
		}
