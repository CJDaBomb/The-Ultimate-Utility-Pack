...
public class SmoothShadowRockStairsBlock extends MoreOresAndArmourModElements.ModElement {
	@ObjectHolder("more_ores_and_armour:smooth_shadow_rock_stairs")
	public static final Block block = null;
	public SmoothShadowRockStairsBlock(MoreOresAndArmourModElements instance) {
		super(instance, 119);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.ROCK).sound(SoundType.STONE)
					.hardnessAndResistance(1.5f, 6f).lightValue(0).harvestLevel(1).harvestTool(ToolType.PICKAXE));
			setRegistryName("smooth_shadow_rock_stairs");
		}
