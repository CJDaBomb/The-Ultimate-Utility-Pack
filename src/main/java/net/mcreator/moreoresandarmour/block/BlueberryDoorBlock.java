...
public class BlueberryDoorBlock extends MoreOresAndArmourModElements.ModElement {
	@ObjectHolder("more_ores_and_armour:blueberry_door")
	public static final Block block = null;
	public BlueberryDoorBlock(MoreOresAndArmourModElements instance) {
		super(instance, 271);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("blueberry_door");
		}
