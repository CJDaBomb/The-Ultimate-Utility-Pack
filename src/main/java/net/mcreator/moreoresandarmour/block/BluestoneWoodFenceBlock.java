...
public class BluestoneWoodFenceBlock extends MoreOresAndArmourModElements.ModElement {
	@ObjectHolder("more_ores_and_armour:bluestone_wood_fence")
	public static final Block block = null;
	public BluestoneWoodFenceBlock(MoreOresAndArmourModElements instance) {
		super(instance, 115);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("bluestone_wood_fence");
		}
