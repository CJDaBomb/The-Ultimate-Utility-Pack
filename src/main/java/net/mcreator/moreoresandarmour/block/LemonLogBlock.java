...
public class LemonLogBlock extends MoreOresAndArmourModElements.ModElement {
	@ObjectHolder("more_ores_and_armour:lemon_log")
	public static final Block block = null;
	@ObjectHolder("more_ores_and_armour:lemon_log")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public LemonLogBlock(MoreOresAndArmourModElements instance) {
		super(instance, 78);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("lemon_log"));
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("lemon_log");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Lemon Log");
		}
