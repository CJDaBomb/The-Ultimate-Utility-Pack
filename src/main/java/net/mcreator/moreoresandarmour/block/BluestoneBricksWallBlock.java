...
public class BluestoneBricksWallBlock extends MoreOresAndArmourModElements.ModElement {
	@ObjectHolder("more_ores_and_armour:bluestone_bricks_wall")
	public static final Block block = null;
	public BluestoneBricksWallBlock(MoreOresAndArmourModElements instance) {
		super(instance, 254);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("bluestone_bricks_wall");
		}
