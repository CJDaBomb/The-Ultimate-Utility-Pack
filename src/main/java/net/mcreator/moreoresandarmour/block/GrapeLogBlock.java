...
public class GrapeLogBlock extends MoreOresAndArmourModElements.ModElement {
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("grape_log"));
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("grape_log");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Grape Log");
		}
