...
import net.mcreator.moreoresandarmour.world.dimension.OtherWorldDimension;
...
public class InfusedTurquoiseBlock extends MoreOresAndArmourModElements.ModElement {
	@ObjectHolder("more_ores_and_armour:infused_turquoise")
	public static final Block block = null;
	public InfusedTurquoiseBlock(MoreOresAndArmourModElements instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("infused_turquoise");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("infused_turquoise", "infused_turquoise", blockAt -> {
