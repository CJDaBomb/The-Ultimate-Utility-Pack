...
public class BlueberryStairsBlock extends MoreOresAndArmourModElements.ModElement {
	@ObjectHolder("more_ores_and_armour:blueberry_stairs")
	public static final Block block = null;
	public BlueberryStairsBlock(MoreOresAndArmourModElements instance) {
		super(instance, 271);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blueberry_stairs");
		}
