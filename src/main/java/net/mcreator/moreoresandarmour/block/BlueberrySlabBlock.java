...
public class BlueberrySlabBlock extends MoreOresAndArmourModElements.ModElement {
	@ObjectHolder("more_ores_and_armour:blueberry_slab")
	public static final Block block = null;
	public BlueberrySlabBlock(MoreOresAndArmourModElements instance) {
		super(instance, 163);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blueberry_slab");
		}
