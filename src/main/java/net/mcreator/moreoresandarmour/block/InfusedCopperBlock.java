...
public class InfusedCopperBlock extends MoreOresAndArmourModElements.ModElement {
	@ObjectHolder("more_ores_and_armour:infused_copper")
	public static final Block block = null;
	public InfusedCopperBlock(MoreOresAndArmourModElements instance) {
		super(instance, 319);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("infused_copper");
		}
