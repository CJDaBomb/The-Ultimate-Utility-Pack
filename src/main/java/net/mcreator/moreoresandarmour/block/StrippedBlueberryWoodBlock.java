...
public class StrippedBlueberryWoodBlock extends MoreOresAndArmourModElements.ModElement {
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry()
				.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("stripped_blueberry_wood"));
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("stripped_blueberry_wood");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Stripped Blueberry Wood");
		}
