...
import net.mcreator.moreoresandarmour.procedures.OilBarrelOnBlockRightClickedProcedure;
import net.mcreator.moreoresandarmour.procedures.OilBarrelNeighbourBlockChangesProcedure;
	...
	public static class CustomBlock extends Block {
		...
		public void neighborChanged(BlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			}
			{
				...
				OilBarrelNeighbourBlockChangesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				OilBarrelOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
