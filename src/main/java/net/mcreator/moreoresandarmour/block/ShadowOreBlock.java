...
import net.mcreator.moreoresandarmour.procedures.ShadowOreBlockDestroyedByPlayerProcedure;
import net.mcreator.moreoresandarmour.procedures.ShadowOreBlockDestroyedByExplosionProcedure;
...
public class ShadowOreBlock extends MoreOresAndArmourModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.3f, 10f).lightValue(0).harvestLevel(7)
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				ShadowOreBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onExplosionDestroy(World world, BlockPos pos, Explosion e) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ShadowOreBlockDestroyedByExplosionProcedure.executeProcedure($_dependencies);
			}
		}
	}
	@Override
