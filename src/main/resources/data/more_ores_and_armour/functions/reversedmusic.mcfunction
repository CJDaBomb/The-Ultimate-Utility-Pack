##### MAIN #####
## Name Jukebox
execute as @e[type=item,nbt={Item:{tag:{display:{Name:'{"text":"Dinnerbone"}'}}}}] at @s align x align y align z unless entity @e[tag=dinnerbone,distance=..0.5] positioned ~0.5 ~-1 ~0.5 if block ~ ~ ~ jukebox run function scripts:name_jukebox
##### /function scripts:name_jukebox #####
...
#kill @s
##### END /function scripts:name_jukebox #####
